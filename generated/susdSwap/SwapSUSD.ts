...
export class SwapSUSD extends ethereum.SmartContract {
  static bind(address: Address): SwapSUSD {
    return new SwapSUSD("SwapSUSD", address);
  }
  ...
  coins_rates(arg0: BigInt): Address {
    let result = super.call("coins_rates", "coins_rates(int128):(address)", [
      ethereum.Value.fromSignedBigInt(arg0)
    ]);
  ...
  try_coins_rates(arg0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("coins_rates", "coins_rates(int128):(address)", [
      ethereum.Value.fromSignedBigInt(arg0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class ConstructorCall__Inputs {
  ...
  get _coins_rates(): Array<Address> {
...
export class Donate_dustCall extends ethereum.Call {
  get inputs(): Donate_dustCall__Inputs {
    return new Donate_dustCall__Inputs(this);
  }

  get outputs(): Donate_dustCall__Outputs {
    return new Donate_dustCall__Outputs(this);
  }
}

export class Donate_dustCall__Inputs {
  _call: Donate_dustCall;

  constructor(call: Donate_dustCall) {
    this._call = call;
  }
...
export class Donate_dustCall__Outputs {
  _call: Donate_dustCall;
