...
export class SwapUSDT extends ethereum.SmartContract {
  static bind(address: Address): SwapUSDT {
    return new SwapUSDT("SwapUSDT", address);
  }
  ...
  calc_token_amount(amounts: Array<BigInt>, deposit: boolean): BigInt {
    let result = super.call(
      "calc_token_amount",
      "calc_token_amount(uint256[3],bool):(uint256)",
      [
