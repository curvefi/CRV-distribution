...
export class SwapCompound2 extends ethereum.SmartContract {
  static bind(address: Address): SwapCompound2 {
    return new SwapCompound2("SwapCompound2", address);
  }
  ...
  A(): BigInt {
    let result = super.call("A", "A():(int128)", []);

    return result[0].toBigInt();
  }

  try_A(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("A", "A():(int128)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  fee(): BigInt {
    let result = super.call("fee", "fee():(int128)", []);

    return result[0].toBigInt();
  }

  try_fee(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("fee", "fee():(int128)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  admin_fee(): BigInt {
    let result = super.call("admin_fee", "admin_fee():(int128)", []);

    return result[0].toBigInt();
  }

  try_admin_fee(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("admin_fee", "admin_fee():(int128)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  future_A(): BigInt {
    let result = super.call("future_A", "future_A():(int128)", []);

    return result[0].toBigInt();
  }

  try_future_A(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("future_A", "future_A():(int128)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  future_fee(): BigInt {
    let result = super.call("future_fee", "future_fee():(int128)", []);

    return result[0].toBigInt();
  }

  try_future_fee(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("future_fee", "future_fee():(int128)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
